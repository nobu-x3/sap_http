...
public:
  ...
  explicit result(success_tag_t, Args &&...args) noexcept(
  ...
  template <typename... Args>
  explicit result(error_tag_t, Args &&...args) noexcept(
  ...
  template <typename TT = value_type, typename EE = error_type,
            typename = std::enable_if_t<std::is_copy_constructible_v<TT> &&
                                        std::is_copy_constructible_v<EE>>>
  ...
  template <typename TT = value_type, typename EE = error_type,
            typename = std::enable_if_t<std::is_move_constructible_v<TT> &&
                                        std::is_move_constructible_v<EE>>>
  ...
  result(const value_type &v) noexcept(
      std::is_nothrow_copy_constructible_v<value_type>)
      : _is_ok(true) {
